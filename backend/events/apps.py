...
def on_tuples_event(channel, tx_status, event_type, asset):
...
def on_compute_plan_event(channel, tx_status, asset):
    ...
    for event_type, assets in payload.items():
        ...
        for asset in assets:
            ...
            if event_type == 'computePlan':
                on_compute_plan_event(channel, tx_status, asset)
            else:
                on_tuples_event(channel, tx_status, event_type, asset)
